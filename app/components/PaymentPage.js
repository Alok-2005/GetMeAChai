...
const PaymentPage = ({ username }) => {
  ...
  }, [username]); // getData depends on username

  useEffect(() => {
    getData();
  }, [getData]); // Only depends on getData, which is stable
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
        ...
        <div className="info flex justify-center items-center my-16 sm:my-20 md:my-24 flex-col gap-4 text-center px-4">
          ...
          <div className="text-gray-400 text-sm sm:text-base">
            ...
            <span className="font-semibold">₹{payments.reduce((a, b) => a + b.amount, 0)}</span> Raised
          </div>
